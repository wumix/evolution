...
class ResourcesManager extends DatabaseManager {
    ...
    public function updateResourcesNextTurn($userID, $resourcesAdd, $resourcesRemove) {
        ...
        $this->database->query('UPDATE ' . self::TABLE_NAME . ' SET', [
            self::COLUMN_GOLD . '+=' => ($resourcesAdd(self::COLUMN_GOLD) - $resourcesRemove(self::COLUMN_GOLD)),
            self::COLUMN_FOOD . '+=' => ($resourcesAdd(self::COLUMN_FOOD) - $resourcesRemove(self::COLUMN_FOOD)),
            self::COLUMN_WEAPONS . '+=' => ($resourcesAdd(self::COLUMN_WEAPONS) - $resourcesRemove(self::COLUMN_WEAPONS)),
            self::COLUMN_STONES . '+=' => ($resourcesAdd(self::COLUMN_STONES) - $resourcesRemove(self::COLUMN_STONES))
